#Assignment 2:  Create a Tuple ('Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'), you should reverse each string in this tuple and save it in list. Output = [yadonM, 'yadseuT', 'yadsendeW', 'yadsruhT','yadirF','yadrutaS','yadnuS']
